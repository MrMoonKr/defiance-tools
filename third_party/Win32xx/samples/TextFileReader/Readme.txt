...
* Inheriting CView from the CScrollView class to create the CView class to display 
  a text document.
...
* Saving the current state of the application in an archive file that is compatible
